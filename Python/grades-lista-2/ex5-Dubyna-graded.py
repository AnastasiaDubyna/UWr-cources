...
# Didactic notes: The exercise asked to test it on a big text file, right? I do not see that here at all...

# For next time, I recommend maybe some final discussion for instance about the really bad choice of a compression
# algorithm, for instance by testing it and comparing it to the plaintext.
# (I am still wondering if we all misunderstood the task somehow...)
